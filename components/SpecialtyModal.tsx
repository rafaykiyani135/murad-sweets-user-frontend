...
export default function SpecialtyModal() {
  const { isSpecialtyModalOpen, closeSpecialtyModal, addToCart } = useCart();
              ...
              <div className="flex items-center justify-between px-5 py-3 border-b border-[#E8C8C8] bg-[#FFF4EE] shrink-0">
                <div>
                  ...
                  <p className="text-[11px] text-gray-500 font-body mt-0.5">
                    Rich and premium specialty sweets for true sweet lovers.
                  </p>
                </div>
                <button onClick={closeSpecialtyModal} className="p-2 rounded-full text-primary-deep/60 hover:text-primary hover:bg-white/80 transition-colors" aria-label="Close modal">
                  <X className="h-5 w-5" />
                </button>
              </div>
